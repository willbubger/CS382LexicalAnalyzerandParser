...
1. Overview
This parser follows a recursive descent approach, parsing expressions according to defined grammar rules. The functions
are structured to ensure correct hierarchical parsing while providing meaningful output for debugging and understanding
the parse process.
